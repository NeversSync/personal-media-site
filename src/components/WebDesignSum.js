    ...
    <Fade >
      <div className="content dark-bg">
        <header>
          ...
          <p>I work as a freelance Web Developer and Designer making websites for businesses and artists. Learn more about my business and see examples of my work on my <a href="http://nickyeversdesign.com/" target="_blank" rel="noreferrer">Nico Evers Design</a> website.</p>
        </header>
        <ul className="actions">
          <li>
            <a href="https://nicoeversdesign.com/" target="_blank" rel="noreferrer" className="button primary">Learn More</a>
          </li>
        </ul>
      </div>
    </Fade>
